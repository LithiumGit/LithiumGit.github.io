    ...
    return (
        <main className="px-5 pt-3 d-flex justify-content-center" style={{minHeight:`calc(100vh - ${Constants.navHeight} - ${Constants.footerHeight})`}}>
            <div className="px-5" style={{maxWidth:700}}>
                ...
                <p className="pt-2">LithiumGit is an open source and <a target="_blank" href="https://opensource.org/license/mit">MIT</a> licensed software. It is maintained
                ...
                <p>If there any question related to privacy policy please send mail to <a href="mailto:tulshi.chandra2.das@gmail.com">tulshi.chandra2.das@gmail.com</a>.</p>
