        ...
        <main className="px-2 pt-3" style={{minHeight:`calc(100vh - ${Constants.navHeight} - ${Constants.footerHeight})`}}>
            <div className="row g-0">
                ...
                <div className="col-12 col-md-8">
                    ...
                    <p className="pt-2">LithiumGit is an open source and <a target="_blank" href="https://github.com/LithiumGit/LithiumGit/blob/master/LICENSE">MIT</a> licensed software. It is maintained
