        ...
        <main className="px-2 pt-3" style={{minHeight:`calc(100vh - ${Constants.navHeight} - ${Constants.footerHeight})`}}>
            <div className="row g-0">
                ...
                <div className="col-12 col-md-8">
                    ...
                    <p className="pt-2">LithiumGit is a free to use software, published under the terms of its <a target="_blank" href="https://github.com/LithiumGit/LithiumGit/blob/master/LICENSE">License</a>. It is maintained
