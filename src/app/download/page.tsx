...
export function generateMetadata(args:IMetadataParams){    
    ...
    data.description = "Download LithiumGit — the free Git GUI client for Windows, Mac, and Linux. Simple installation, no sign-up required. Start managing your Git repositories today.";
    data.openGraph!.title = "Download LithiumGit | Free Git GUI for Windows, Mac & Linux";
    data.openGraph!.description = "Download LithiumGit — the free Git GUI client for Windows, Mac, and Linux. No sign-up required.";
    (data as any).twitter = {
        ...(data as any).twitter,
